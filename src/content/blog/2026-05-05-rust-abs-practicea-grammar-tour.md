...
|---|---|---|
| `fn main()` 構造 | [ch1.2](https://doc.rust-jp.rs/book-ja/ch01-02-hello-world.html) / [ch3.3](https://doc.rust-jp.rs/book-ja/ch03-03-how-functions-work.html) | コード全体 |
| `io::stdin().read_line()` | [ch2](https://doc.rust-jp.rs/book-ja/ch02-00-guessing-game-tutorial.html) | `line1` 〜 `line3` の入力 |
| 可変借用 `&mut buf` | [ch4](https://doc.rust-jp.rs/book-ja/ch04-00-understanding-ownership.html) | `read_line(&mut line1)` |
| `String` vs `&str` | [ch4](https://doc.rust-jp.rs/book-ja/ch04-00-understanding-ownership.html) | `String::new()` と `trim()` の戻り値 |
| `trim()` | [ch2](https://doc.rust-jp.rs/book-ja/ch02-00-guessing-game-tutorial.html) | `line1.trim()` |
| `parse::<T>()` / 型注釈 | [ch2](https://doc.rust-jp.rs/book-ja/ch02-00-guessing-game-tutorial.html) + [ch9](https://doc.rust-jp.rs/book-ja/ch09-00-error-handling.html) | `let a: i32 = ...parse()` |
| `Result<T, E>` / `expect("...")` | [ch9](https://doc.rust-jp.rs/book-ja/ch09-00-error-handling.html) | `.expect("...")` |
| `split_whitespace()` + `collect()` | [ch8](https://doc.rust-jp.rs/book-ja/ch08-00-common-collections.html) + [ch13](https://doc.rust-jp.rs/book-ja/ch13-00-functional-features.html) | `line2` の分割 |
| `Vec<&str>` | [ch8](https://doc.rust-jp.rs/book-ja/ch08-00-common-collections.html) | `parts[0]` / `parts[1]` |
| `println!` マクロ | [ch1.2](https://doc.rust-jp.rs/book-ja/ch01-02-hello-world.html) / [ch3](https://doc.rust-jp.rs/book-ja/ch03-00-common-programming-concepts.html) | 結果出力 |
